          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="pages_financial_reporting_deposits.php">Advanced Reporting</a></li>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4>All Transactions Under Deposits Category</h4>
              </div>
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>रु॰ <?php echo $row->transaction_amt; ?></td>
