                                        ...
                                        <div class="col-12 table-responsive">
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>रु॰ <?php echo $deposit; ?></td>
                                                        <td>रु॰ <?php echo $withdrawal; ?></td>
                                                        <td>रु॰ <?php echo $Transfer; ?></td>
                                                        <td>रु॰ <?php echo $money_in; ?></td>
                                                    </tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>रु॰ <?php echo $rate_amt; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Total Balance:</th>
                                                        <td>रु॰ <?php echo $totalMoney; ?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
